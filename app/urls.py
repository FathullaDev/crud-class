...
#
#     path('otm/<int:otm_id>/groups/', views.groups_by_otm, name='groups_by_otm'),
#     path('otm/<int:otm_id>/groups/<int:group_id>/students/',
#          views.students_by_groups_and_otm,
#          name='students_by_groups_and_otm'),
#
#     # Create (CBV)
#     path('add_otm/', OtmCreateView.as_view(), name='add_otm'),
#     path('add_group/', GroupCreateView.as_view(), name='add_group'),
#     path('add_student/', StudentCreateView.as_view(), name='add_student'),
#
#     # Update (CBV)
#     path('update_otm/<int:otm_id>/',
#          OtmUpdateView.as_view(),
#          name='update_otm'),
#
#     path('update_group/<int:group_id>/',
...
#
#     # Delete (CBV)
#     path('delete_otm/<int:otm_id>/',
#          OtmDeleteView.as_view(),
#          name='delete_otm'),
#
#     path('delete_group/<int:group_id>/',
